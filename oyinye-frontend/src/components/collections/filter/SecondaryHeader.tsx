...
export default function SecondaryHeader({
  ...
  return (
    <>
      <header
        className={`${headerClass} text-[.9rem] text-gray-500 font-medium font-sans flex flex-row  ${
          category === "basics" ? "justify-center" : "justify-between"
      ...
      >
        {category !== "basics" && (
          <button
            ...
            onClick={(e) => {
              let leftAngle = document.querySelector("fa-solid.fa-angle-left");
              if (leftAngle) {
          ...
          >
            <div className="inline-flex flex-row gap-x-2">
              ...
              <h5>
                Filter
                {filter.noOfFilters > 0 && (
                  <span>&nbsp;&#40;{filter.noOfFilters}&#x29;</span>
                )}
              </h5>
            </div>
            <i
              className={`fa-solid fa-angle-left text-sm text-gray-500 transform transition-transform ease-in duration-400 ${
                filter.isVisible ? "rotate-0" : "-rotate-180"
              }`}
            ></i>
          </button>
        )}
        {category !== "basics" && (
          <div
            className={`md:hidden inline-flex flex-row gap-x-4 items-center cursor-pointer absolute left-3 ${
              classes ? "" : "-top-6"
            }`}
        ...
        <div className="inline-flex flex-row items-center gap-x-2 md:w-fit w-[45%]">
          <span className="md:inline-block hidden w-[20%]">Sort by:</span>
          <div
            onClick={(e) => {
          ...
          >
            ...
            >
              ...
              {sortByList.map((val: string, i: number) => (
                <option
            ...
            <i
              ...
              className={`fa-solid fa-angle-down absolute top-[35%] right-3 transfrom transition-transform duration-300 ease-in-out ${
          ...
          <span
            className={`absolute right-[20%] inline-block md:hidden ${
              classes ? "" : "-top-6"
            }`}
          >
            {productsLength}&nbsp;products
          ...
          <div
            className={`inline-flex flex-row gap-x-2 md:hidden absolute right-3 ${
              classes ? "" : "-top-6"
            }`}
          >
            <i
              onClick={() => setIsGridView((prevState: any) => !prevState)}
              className={`fa-solid fa-grip cursor-pointer text-[1.35rem] ${
                isGridView ? "text-gray-500" : "text-gray-300"
              }`}
            ></i>
            <i
              onClick={() => setIsGridView((prevState: any) => !prevState)}
              className={`fa-regular fa-square cursor-pointer text-[1.35rem] ${
                !isGridView ? "text-gray-500" : "text-gray-300"
              }`}
            ></i>
          </div>
      ...
      {isFilterModalOpen && windowWidth < 768 && (
            ...
            <div className="flex flex-col gap-y-5">
              <div className="flex flex-col gap-y-5">
                <header
                  ...
                  onClick={(e) => {
                    let upAngle = e.currentTarget.querySelector(
                      "#sortby-header > i"
                    );
                ...
                <div id="sortby-content" className="flex flex-col gap-y-5">
              ...
              <div className="flex flex-col gap-y-5">
                ...
                <ul
                  id="fabric-content"
                  className="hide hidden border border-l-0 border-r-0 border-t-0 pb-4 border-gray-300 flex-col font-sans text-[.9rem] text-gray-500 gap-y-2 font-normal"
                >
                    ...
                    >
                      <input
                        ...
                        className="text-white bg-white appearance-none w-[16px] h-[16px] border border-gray-500 rounded-sm relative
                                  ...
                                  checked:after:border-white checked:after:border-r-2 checked:after:border-b-2 checked:after:border-t-0 checked:after:border-l-0
                                  checked:after:rotate-45"
                        checked={filter.customProp.name === item ? true : false}
                      />
                      <span>{item}</span>
                    </li>
                  ))}
