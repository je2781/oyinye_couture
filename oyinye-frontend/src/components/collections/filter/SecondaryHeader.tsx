    ...
    return (
      <>
          ...
          {category !== 'basics' && <div
            ...
            onClick={(e) => {
                let leftAngle = document.querySelector(".collections-left-angle-container > i");
                if (leftAngle) {
            ...
            <div className="inline-flex flex-row gap-x-2">
                {filter.isVisible ? (
                <Image src='/on.png' alt="slider-activated" height={19} width={19} />
                ) : (
                <Image src='/off.png' alt="slider-deactivated" height={19} width={19} />
                )}
                <h5>
                Filter{filter.noOfFilters > 0 && <span>&nbsp;&#40;{filter.noOfFilters}&#x29;</span>}
                </h5>
            </div>
           <div className="inline-block collections-left-angle-container">
           <i className="fa-solid fa-angle-left text-sm text-gray-500"></i>
           </div>
                ...
                <div className="flex flex-col gap-y-5">
                    ...
                    <div className="flex flex-col gap-y-5">
                        <header
                            ...
                            onClick={(e) => {
                                let upAngle = e.currentTarget.querySelector("#sortby-header > i");
