...
const ProductComponent = ({ product, isSearchProduct, imageH, imageW, isGridView, isOnDetailPage, isAdmin, handleEdit, handleDelete}: any) => {
    ...
    const showModalHandler = (e: React.MouseEvent) => {
      ...
      item.classList.remove('animate-hintExpand');
      setIsModalOpen(true);
        ...
        <>
          <article
            onMouseLeave={(e) => {
              if(!isModalOpen){
                ...
                if(product.is_hidden){
                  ...
                  hiddenHint.classList.remove('animate-hintExpand');
                }
            ...
            onMouseOver={(event) => {
              if (!isModalOpen) {
                ...
                if(product.is_hidden){
                  const hiddenHint = document.querySelector('#is-hidden') as HTMLDivElement;
                  hiddenHint.classList.add('animate-hintExpand');
                }
              }
          ...
          onMouseOver={(event) => {
            if(!isModalOpen){
              ...
              const item = event.currentTarget;
              item.classList.add('animate-hintExpand');
          ...
          <article
            ...
            onMouseLeave={(e) => {
              if(!isModalOpen){
                ...
                zoomHint.classList.remove('animate-hintExpand');
              }
            ...
            onMouseOver={(event) => {
              if (!isModalOpen) {
                ...
                zoomHint.classList.add('animate-hintExpand');
              }
