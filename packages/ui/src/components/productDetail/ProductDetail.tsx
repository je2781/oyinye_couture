            ...
            <section className="flex lg:flex-row flex-col gap-y-7">
                ...
                <section className=" w-full lg:px-12 px-6 lg:w-[54%] lg:h-full lg:pt-8 flex flex-col gap-y-5">
                    ...
                    <div className="mt-2 flex flex-col gap-y-3 xl:w-[80%] w-full">
                        ...
                        >{loader ?  <div className="loader animate-spin" ></div> : <span>Add to cart</span>}</button>
                        <button onClick={async() => {
                            try {
                                setIsBuyingNow(true);
                                const cartPostRes = await axios.post('/api/products/cart', {
                                ...
                                const cartUpdateRes = await axios.patch('/api/products/cart/update',{
                                    headers: {
                                        "x-csrf-token": csrf,
                                      }
                                });
                        ...
                        }} className="font-sans xl:px-44 px-28 py-2 ring-[#5a31f4] hover:bg-[#512bd8] hover:ring-1 bg-[#5a31f4] text-white">{isBuyingNow ?  <div className="loader animate-spin" ></div> : <span>Buy it now</span>}</button>
                    </div>
                    <div className="gap-y-3 mt-3 w-full flex flex-col">
                        <div className="flex flex-col gap-y-2">
                            <header 
                                onClick={(e) => {
                                    ...
                                    if (downAngle && header && content) {
                                        if (!downAngle.classList.contains("animate-angleDownRotate")) {
                                            ...
                                            content.classList.add("animate-showChart");
                                            content.classList.remove("animate-hideChart");
                                        } else {
                                            downAngle.classList.remove("animate-angleDownRotate");
                                            downAngle.classList.add("animate-angleDownRotateAnti");
                                            content.classList.remove("animate-showChart");
                                            content.classList.add("animate-hideChart");
                                        }
                                    }
                                }}
                                ...
                                <h1 className="flex flex-row gap-x-3">
                                    <Image src='/ruler.svg' alt='ruler' role='presentation' className="w-6 lg:w-[28px]"/>
                            ...
                            <div id='sizes-content' className="border border-gray-200 pt-3 pb-6 px-5 lg:ml-3 lg:mr-12 mr-5 flex-col gap-y-4 hidden">
                                <header className="flex flex-row justify-between">
                                    ...
                                    <Image src='/oyinye.png' alt="logo" role='presentation' width={240} className="lg:w-[35%] w-[40%]"/>
                                </header>
                        ...
                        <div>
                            <header 
                                ...
                                <h1 className="flex flex-row gap-x-3">
                                    <Image src='/truck.svg' alt='delivery-truck' role='presentation' className="w-6 lg:w-[28px]"/>
