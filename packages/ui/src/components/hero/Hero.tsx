    ...
    <section className="w-full">
      ...
      >
        <SwiperSlide>
          ...
          >
            <section className="animate-slideTextUp flex flex-col items-center justify-center gap-y-6 absolute bottom-[30%] top-[30%] lg:left-[30%] lg:right-[30%] left-[8%] right-[8%]">
