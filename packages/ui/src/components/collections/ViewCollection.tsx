...
const ViewCollection = ({featuredProducts}: any) => {
  return (
    <div className="flex flex-col gap-y-8 bg-white w-full lg:py-12 py-8 mx-auto px-6 container">
      <section className="flex flex-col gap-y-6 items-center justify-center animate-slideTextUp">
      ...
      <section className="flex flex-col lg:items-start items-center gap-y-5 font-sans">
        <header className="lg:text-4xl text-3xl font-normal animate-slideTextUp">
            Featured Products
        </header>
        <div className="flex flex-row items-center justify-evenly flex-wrap lg:gap-x-2 gap-x-1 gap-y-4 animate-slideTextUp">
        ...
        <div className="animate-slideTextUp flex flex-row w-full justify-center -mt-2">
