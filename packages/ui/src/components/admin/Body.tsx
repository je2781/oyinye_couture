...
import { Base64ImagesObj, CartItemObj, EmailType, Locale, SizeData, Value } from "../../../../interfaces";
...
export default function Body({
  ...
  const hideAdminSettingsModalHandler = () => {
      ...
      if (adminModal) {
        adminModal.classList.remove('animate-slideDown');
        adminModal.classList.add('animate-slideUp');
  ...
  React.useEffect(() => {
    ...
    if (isAdminSettingsOpen && adminModal) {
      adminModal.classList.add('animate-slideDown');
      adminModal.classList.remove('animate-slideUp');
    }
  }, [isAdminSettingsOpen]);
              ...
              >
                ...
                <div className="text-secondary-400 flex flex-col gap-y-7 text-sm w-full">
                  <div className="flex flex-col justify-center gap-y-1 focus:outline-none w-full h-10 border border-t-0 border-l-0 border-r-0 border-secondary-400">
                    <label htmlFor="title" className="text-xs animate-hideLabel text-gray-500">
                      Title
                    </label>
                    <input
                      placeholder="Title"
                      onBlur={(e) => {
                        ...
                        if (label && item.value.length === 0) {
                          label.classList.add("animate-hideLabel");
                          label.classList.remove("animate-showLabel");
                        }
                      ...
                      onKeyDown={(e) => {
                        ...
                        if (e.key === "Backspace" && label) {
                          label.classList.remove("animate-hideLabel");
                          label.classList.add("animate-showLabel");
                        }
                      }}
                      onInput={(e) => {
                        let item = e.currentTarget;
                  ...
                  <div className="flex flex-col justify-center gap-y-1 focus:outline-none w-full border border-t-0 border-l-0 border-r-0 border-secondary-400">
                    <label htmlFor="desc" className="text-xs animate-hideLabel text-gray-500">
                      Description
                    </label>
                    <textarea
                      cols={15}
                  ...
                  <div className="w-full flex flex-row">
                    <div className="flex flex-col justify-center w-[45%] gap-y-1 focus:outline-none h-10 border border-t-0 border-l-0 border-r-0 border-secondary-400">
                      <label
                        htmlFor="type"
                        className="text-xs animate-hideLabel text-gray-500"
                      >
                        Type
                      </label>
                      <input
                  ...
                  <div className="flex flex-col justify-center gap-y-1 h-10 focus:outline-none w-full border border-t-0 border-l-0 border-r-0 border-secondary-400">
                    <label htmlFor="price" className="text-xs animate-hideLabel focus:outline-none text-gray-500">
                      Price
                    </label>
                    <input
                      onBlur={(e) => {
                  ...
                  >
                    {isLoading ? (
                      <div className="border-2 border-transparent rounded-full border-t-accent border-r-accent w-[15px] h-[15px] spin animate-spin"></div>
                    ) : (
                      <span>
                    ...
                    {loader && (
                      <div className="absolute bottom-0 left-0 w-full h-[4px]">
                        <div className="trailing-progress-bar w-full">
                          <div className="trailing-progress animate-loading bg-blue-500 h-full"></div>
                        </div>
                      </div>
                    )}
                  </thead>
                              ...
                              <div className="flex flex-col gap-y-7 w-full">
                                <div className="flex flex-col w-full gap-y-6">
                                  ...
                                  <button onClick={async (e) => {
                                    ...
                                    {isLoading ? <span className="border-2 border-transparent rounded-full border-t-white border-r-white w-[15px] h-[15px] spin animate-spin"></span> : 'Update Status'}
                                  </button>
                                </div>
                                {order.paymentType === "streetzwyze" && (
                                  <div className="flex flex-col gap-y-3 w-full">
                                    ...
                                    <div className="h-24 flex flex-col items-start gap-y-2 w-full">
                                      ...
                                      <button onClick={async (e) => {
                                        ...
                                        try {
                                          setIsLoading(true);
                                          const res = await axios.post('/api/orders/send/payment-request', {
                                        ...
                                        {isLoading ? <span className="border-2 border-transparent rounded-full border-t-white border-r-white w-[15px] h-[15px] spin animate-spin"></span> : <span>Send&nbsp;&nbsp;
                ...
                <section className='md:max-w-[60%] w-full flex flex-row flex-wrap lg:flex-nowrap justify-start items-center text-sm gap-x-2 gap-y-2 mt-6'>
                  <div className="lg:inline-block lg:max-w-[28%] hidden relative">
                      ...
                      onClick={(e) => {
                          ...
                          if(calendarAngleDown?.classList.contains('animate-angleDownRotate')){
                            calendarAngleDown?.classList.remove("animate-angleDownRotate");
                            calendarAngleDown?.classList.add("animate-angleDownRotateAnti");
                          }
                          if(filterAngleDown?.classList.contains('animate-angleDownRotate')){
                            filterAngleDown?.classList.remove("animate-angleDownRotate");
                            filterAngleDown?.classList.add("animate-angleDownRotateAnti");
                          }
                          if(activeActionAngleDown?.classList.contains('animate-angleDownRotate')){
                            activeActionAngleDown?.classList.remove("animate-angleDownRotate");
                            activeActionAngleDown?.classList.add("animate-angleDownRotateAnti");
                          }

                          dropdowns.forEach(dropdown => {
                            if(dropdown.classList.contains('animate-showContent')){
                              dropdown.classList.add('animate-hideContent', 'hidden');
                              dropdown.classList.remove('animate-showContent');
                            }
                          });

                          if(downAngle && actionsDropdown){
                            if(!downAngle.classList.contains("animate-angleDownRotate")){
                                downAngle.classList.add("animate-angleDownRotate");
                                downAngle.classList.remove("animate-angleDownRotateAnti");
                                actionsDropdown.classList.remove('animate-hideContent', 'hidden');
                                actionsDropdown.classList.add('animate-showContent');
                            }else{
                                downAngle.classList.remove("animate-angleDownRotate");
                                downAngle.classList.add("animate-angleDownRotateAnti");
                                actionsDropdown.classList.add('animate-hideContent', 'hidden');
                                actionsDropdown.classList.remove('animate-showContent');
                            }
                          }
                      }}
                      id='actions-button'
                  ...
                  <div className="lg:inline-block lg:max-w-[15%] hidden relative">
                      <button 
                        onClick={(e) => {
                          ...
                          if(actionsAngleDown?.classList.contains('animate-angleDownRotate')){
                            actionsAngleDown?.classList.remove("animate-angleDownRotate");
                            actionsAngleDown?.classList.add("animate-angleDownRotateAnti");
                          }
                          if(filterAngleDown?.classList.contains('animate-angleDownRotate')){
                            filterAngleDown?.classList.remove("animate-angleDownRotate");
                            filterAngleDown?.classList.add("animate-angleDownRotateAnti");
                          ...
                          if(downAngle && calendarDropdown){
                            if(!downAngle.classList.contains("animate-angleDownRotate")){
                                downAngle.classList.add("animate-angleDownRotate");
                                downAngle.classList.remove("animate-angleDownRotateAnti");
                                calendarDropdown.classList.remove('animate-hideContent', 'hidden');
                                calendarDropdown.classList.add('animate-showContent');
                            }else{
                                downAngle.classList.remove("animate-angleDownRotate");
                                downAngle.classList.add("animate-angleDownRotateAnti");
                                calendarDropdown.classList.add('animate-hideContent', 'hidden');
                                calendarDropdown.classList.remove('animate-showContent');
                            }
                          }
                        }}
                      ...
                      onClick={(e) => {
                          ...
                          if(downAngle && filterDropdown){
                              if(!downAngle.classList.contains("animate-angleDownRotate")){
                                  downAngle.classList.add("animate-angleDownRotate");
                                  downAngle.classList.remove("animate-angleDownRotateAnti");
                                  filterDropdown.classList.remove('animate-hideContent', 'hidden');
                                  filterDropdown.classList.add('animate-showContent');
                              }else{
                                  downAngle.classList.remove("animate-angleDownRotate");
                                  downAngle.classList.add("animate-angleDownRotateAnti");
                                  filterDropdown.classList.add('animate-hideContent', 'hidden');
                                  filterDropdown.classList.remove('animate-showContent');
                              }
                          }
                      }}
                      id='filter-button'
                                      ...
                                      onClick={(e) => {
                                        ...
                                        if(downAngle && activeActionDropdown){
                                            if(!downAngle.classList.contains("animate-angleDownRotate")){
                                                downAngle.classList.add("animate-angleDownRotate");
                                                downAngle.classList.remove("animate-angleDownRotateAnti");
                                                activeActionDropdown.classList.remove('animate-hideContent', 'hidden');
                                                activeActionDropdown.classList.add('animate-showContent');
                                            }else{
                                                downAngle.classList.remove("animate-angleDownRotate");
                                                downAngle.classList.add("animate-angleDownRotateAnti");
                                                activeActionDropdown.classList.add('animate-hideContent', 'hidden');
                                                activeActionDropdown.classList.remove('animate-showContent');
                                            }
                                        }
                                    }}
                                  >
                        ...
                        isAdminSettingsOpen && pathName === "emails" && <AdminSettingsModal onClose={hideAdminSettingsModalHandler} left='20rem' width='40rem' classes='h-fit bg-white'>
                          <section className="flex flex-col items-start gap-x-2 w-full h-full px-5 pb-6 pt-16 font-sans gap-y-9">
                                ...
                                <form onSubmit={async (e) => {
                                  ...
                                  try {
                                    setLoader(true);
                                    const res = await axios.post('/api/admin/send-reminder', {
