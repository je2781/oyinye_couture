...
const QuickViewModalOverlay = (props: any) => {
  return (
    <main 
    className="modal animate-slideDown shadow-2xl flex lg:flex-row flex-col items-center lg:h-[480px] h-[80vh] overflow-y-auto bg-white">
      {props.children}
    </main>
  );
};
...
const SearchModalOverlay = (props: any) => {
  return (
    <main 
    className="search-modal animate-slideDown flex flex-row justify-center h-28 bg-white w-full py-7 fixed top-0 left-0 z-[45]">
      {props.children}
    </main>
  );
};
