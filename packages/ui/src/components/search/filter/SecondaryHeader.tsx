            ...
            <header className={`${headerClass} flex flex-row justify-between items-start w-full relative mb-2`} >
                <div
                    ...
                    onClick={(e) => {
                        ...
                        if (leftAngle) {
                            if (!leftAngle.classList.contains("animate-angleLeftRotate")) {
                                leftAngle.classList.add("animate-angleLeftRotate");
                                leftAngle.classList.remove("animate-angleLeftRotateClock");
                            } else {
                                leftAngle.classList.remove("animate-angleLeftRotate");
                                leftAngle.classList.add("animate-angleLeftRotateClock");
                            }
                        }
                    ...
                    <div className="inline-flex flex-row gap-x-2">
                        {filter.isVisible ? (
                        <Image src='/on.png' alt="slider-activated" height={19} />
                        ) : (
                        <Image src='/off.png' alt="slider-deactivated" height={19} />
                        )}
                        ...
                        onClick={(e) => {
                            ...
                            if (downAngle && ul && section && text) {
                                if (!downAngle.classList.contains("animate-angleDownRotate")) {
                                    if (sort === "Relevance") {
                                        text.classList.add("animate-slideLeft");
                                        text.classList.remove("animate-reverseSlideLeft");
                                    }
                                    ...
                                    if (sort === "Relevance") {
                                        text.classList.add("animate-reverseSlideLeft");
                                        text.classList.remove("animate-slideLeft");
                                    }
                    ...
                    <div className="flex flex-col gap-y-5">
                        <header
                            ...
                            onClick={(e) => {
                                ...
                                if (upAngle && header) {
                                if (!upAngle.classList.contains("animate-angleUpRotate")) {
                                    upAngle.classList.add("animate-angleUpRotate");
                                    upAngle.classList.remove("animate-angleUpRotateClock");
                                    content?.classList.remove("animate-showContent");
                                    content?.classList.add("animate-hideContent");
                                } else {
                                    upAngle.classList.remove("animate-angleUpRotate");
                                    upAngle.classList.add("animate-angleUpRotateClock");
                                    content?.classList.add("animate-showContent");
                                    content?.classList.remove("animate-hideContent");
                                }
                                }
                            }}
                        >
