    ...
    for(let j = 0; j < Object.values(sortedDailyDataLabels)[i]!.length; j++){
      ...
      for(let order of orders){
        ...
        if ( extractedDate.getDate() === Object.values(Object.values(sortedDailyDataLabels)[i]![j])[0] && extractedDate.getFullYear() === (currentMonth === 0 && currentDate -(j+1) <= 0 ? currentYear -1 : currentYear) && extractedDate.getMonth() === (currentMonth === 0 && currentDate -(j+1) <= 0 ? 11 : currentDate - (j+1) <= 0 ? currentMonth-1 : currentMonth)) {
          ...
          dailySalesDataAmount[i+1]![Object.values(Object.values(sortedDailyDataLabels)[i]![j])[0] as string] = dailySalesData[i + 1]![Object.keys(Object.values(sortedDailyDataLabels)[i]![j]!)[0]!]!.map((saleData: any) => saleData.sale).reduce((prev: number, current: number) => prev + current, 0.0);
          dailyDressesSalesDataAmount[i+1]![Object.keys(Object.values(sortedDailyDataLabels)[i]![j])[0]!] = dailySalesData[i + 1]![Object.keys(Object.values(sortedDailyDataLabels)[i]![j]!)[0]!]!.map((saleData: any) => {
            ...
            return sales;
          }).filter((sales: any) => sales > 0).reduce((prev: number, current: number) => prev + current, 0.0);
          dailyJumpsuitSalesDataAmount[i+1]![Object.keys(Object.values(sortedDailyDataLabels)[i]![j])[0]!] = dailySalesData[i + 1]![Object.keys(Object.values(sortedDailyDataLabels)[i]![j]!)[0]!]!.map((saleData: any) => {
          ...
          dailyTrousersSalesDataAmount[i+1]![Object.keys(Object.values(sortedDailyDataLabels)[i]![j])[0]!] = dailySalesData[i + 1]![Object.keys(Object.values(sortedDailyDataLabels)[i]![j]!)[0]!]!.map((saleData: any) => {
          ...
          datasets: [
            {
              ...
              data:  [
                  Object.values(dailyNoOfAddToCart[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0) + 
                  Object.values(dailyNoOfCheckout[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0) +
                  Object.values(dailyNoOfClosed[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                  Object.values(dailyNoOfAddToCart[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                  Object.values(dailyNoOfCheckout[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                  Object.values(dailyNoOfClosed[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0)
                ],
        ...
        datasets: [
            {
              ...
              data:  [
                  Object.values(dailyDressesSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                  Object.values(dailyJumpsuitSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                  Object.values(dailyTrousersSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0)
                ],
                backgroundColor: [
                'rgba(255, 165, 0, 0.5)',
                'rgba(81, 178, 202, 0.5)',
        ...
        datasets: [
            {
              ...
              data:  [
                    Object.values(dailyNoOfMainland[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(dailyNoOfIsland[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(dailyNoOfOutside[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0)
                ],
                backgroundColor: [
                'rgba(255, 165, 0, 0.5)',
                'rgba(81, 178, 202, 0.5)',
      ...
      dailyPaymentTypeData[i+1]! = {
        ...
        datasets: [{
            ...
            data: [
              Object.values(dailyNoOfStreetzwyze[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
              Object.values(dailyNoOfInterswitch[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
            ],
            backgroundColor: [
              'rgba(255, 165, 0, 0.5)',
              'rgba(81, 178, 202, 0.5)'
    ...
    for(let j = 0; j < Object.values(sortedMonthDataLabels)[i]!.length; j++){
      ...
      for(let order of orders){
        ...
        if (  extractedDate.getMonth() === parseInt(Object.keys(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!) && extractedDate.getFullYear() === parseInt(Object.values(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!.split('-')[1]!)) {
          ...
          monthSalesDataAmount[i+1]![Object.values(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!]! = monthSalesData[i + 1]![Object.keys(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!]!.map((saleData: any) => saleData.sale).reduce((prev: number, current: number) => prev + current, 0.0);
          monthDressesSalesDataAmount[i+1]![Object.keys(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!] = monthSalesData[i + 1]![Object.keys(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!]!.map((saleData: any) => {
            let sales = saleData.items.filter((item: any)=> item.productType  === 'Dresses').map((item: any) => item.total).reduce((prev: number, current: number) => prev + current, 0.0);
            return sales;
          }).filter((sales: any) => sales > 0).reduce((prev: number, current: number) => prev + current, 0.0);
          monthJumpsuitSalesDataAmount[i+1]![Object.keys(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!] = monthSalesData[i + 1]![Object.keys(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!]!.map((saleData: any) => {
            let sales = saleData.items.filter((item: any)=> item.productType  === 'Jumpsuit').map((item: any) => item.total).reduce((prev: number, current: number) => prev + current, 0.0);
            return sales;

          }).filter((sales: any) => sales > 0).reduce((prev: number, current: number) => prev + current, 0.0);
          monthTrousersSalesDataAmount[i+1]![Object.keys(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!] = monthSalesData[i + 1]![Object.keys(Object.values(sortedMonthDataLabels)[i]![j]!)[0]!]!.map((saleData: any) => {
            let sales = saleData.items.filter((item: any)=> item.productType  === 'Trousers').map((item: any) => item.total).reduce((prev: number, current: number) => prev + current, 0.0);
            return sales;
        ...
        datasets: [
            {
              ...
              data:  [
                Object.values(monthNoOfAddToCart[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0) + 
                Object.values(monthNoOfCheckout[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0) +
                Object.values(monthNoOfClosed[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                Object.values(monthNoOfAddToCart[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                Object.values(monthNoOfCheckout[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                Object.values(monthNoOfClosed[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),,
                ],
        ...
        datasets: [
            {
              ...
              data:  [
                    Object.values(monthDressesSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(monthJumpsuitSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(monthTrousersSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0)
                ],
                backgroundColor: [
                'rgba(255, 165, 0, 0.5)',
                'rgba(81, 178, 202, 0.5)',
        ...
        datasets: [
            {
              ...
              data:  [
                    Object.values(monthNoOfMainland[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(monthNoOfIsland[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(monthNoOfOutside[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0)
                ],
                backgroundColor: [
                'rgba(255, 165, 0, 0.5)',
                'rgba(81, 178, 202, 0.5)',
      ...
      monthPaymentTypeData[i+1] = {
        ...
        datasets: [{
            label: 'Payment Type Selected',
            data: [
              Object.values(monthNoOfStreetzwyze[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
              Object.values(monthNoOfInterswitch[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
            ],
            backgroundColor: [
              'rgba(255, 165, 0, 0.5)',
              'rgba(81, 178, 202, 0.5)'
    ...
    if(!annualSalesData[i+1]){
        ...
        for(let order of orders){
          ...
          if (annualDataLabels[i+1]![j] === extractedDate.getFullYear()) {
           ...
           annualNoOfOutside[i+1]![annualDataLabels[i+1]![j]!]! += order.shippingMethod === 'outside' ? 1 : 0;
            ...
            annualSalesDataAmount[i+1]![annualDataLabels[i+1]![j]!] = annualSalesData[i+1]![annualDataLabels[i+1]![j]!]!.map((saleData: any) => saleData.sale).reduce((prev: number, current: number) => prev + current, 0.0);
            annualDressesSalesDataAmount[i+1]![annualDataLabels[i+1]![j]!] = annualSalesData[i+1]![annualDataLabels[i+1]![j]!]!.map((saleData: any) => {
              let sales = saleData.items.filter((item: any)=> item.productType  === 'Dresses').map((item: any) => item.total).reduce((prev: number, current: number) => prev + current, 0.0);
              return sales;
            }).filter((sales: any) => sales > 0).reduce((prev: number, current: number) => prev + current, 0.0);
            annualJumpsuitSalesDataAmount[i+1]![annualDataLabels[i+1]![j]!] = annualSalesData[i+1]![annualDataLabels[i+1]![j]!]!.map((saleData: any) => {
              let sales = saleData.items.filter((item: any)=> item.productType  === 'Jumpsuit').map((item: any) => item.total).reduce((prev: number, current: number) => prev + current, 0.0);
              return sales;
            }).filter((sales: any) => sales > 0).reduce((prev: number, current: number) => prev + current, 0.0);
            annualTrousersSalesDataAmount[i+1]![annualDataLabels[i+1]![j]!] = annualSalesData[i+1]![annualDataLabels[i+1]![j]!]!.map((saleData: any) => {
              let sales = saleData.items.filter((item: any)=> item.productType  === 'Trousers').map((item: any) => item.total).reduce((prev: number, current: number) => prev + current, 0.0);
              return sales;
            }).filter((sales: any) => sales > 0).reduce((prev: number, current: number) => prev + current, 0.0);
          }
        ...
        datasets: [
            {
              ...
              data:  [
                Object.values(annualNoOfAddToCart[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0) + 
                Object.values(annualNoOfCheckout[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0) +
                Object.values(annualNoOfClosed[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                Object.values(annualNoOfAddToCart[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                Object.values(annualNoOfCheckout[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                Object.values(annualNoOfClosed[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0)
                ],
        ...
        datasets: [
            {
              ...
              data:  [
                    Object.values(annualDressesSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(annualJumpsuitSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(annualTrousersSalesDataAmount[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0)
                ],
                backgroundColor: [
                'rgba(255, 165, 0, 0.5)',
                'rgba(81, 178, 202, 0.5)',
        ...
        datasets: [
            {
              ...
              data:  [
                    Object.values(annualNoOfMainland[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(annualNoOfIsland[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
                    Object.values(annualNoOfOutside[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0)
                ],
                backgroundColor: [
                'rgba(255, 165, 0, 0.5)',
                'rgba(81, 178, 202, 0.5)',
      ...
      annualPaymentTypeData[i+1] = {
        ...
        datasets: [{
            label: 'Payment Type Selected',
            data: [
              Object.values(annualNoOfStreetzwyze[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
              Object.values(annualNoOfInterswitch[i+1]!).reduce((prev: number, current: number) => prev + current, 0.0),
            ],
            backgroundColor: [
              'rgba(255, 165, 0, 0.5)',
              'rgba(81, 178, 202, 0.5)'
