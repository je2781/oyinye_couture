...
export default function PagesComponent({name}: any){
    ...
    async function handleFormSubmit(e: React.FormEvent){
        ...
        try {
            setLoader(true);
            await axios.post(`/api/enquiries/contact`, {
                email,
            ...
            content = (
                <main className="container mx-auto bg-white min-h-screen max-w-7xl lg:pb-12 lg:pt-16 py-8 lg:px-8 px-6 flex flex-row font-sans">
                    <article className="flex flex-col w-full gap-y-11 lg:w-[50%]">
                        <header className="lg:text-6xl text-4xl font-light">Our Studio</header>
                        ...
                        <div className="w-full flex flex-col gap-y-6">
                            ...
                            <p className="font-light">
                                Have a question or looking for more information about our products,<br/> please fill out the form below or email us at <Link href='mailto:hello@oyinye.com' className='underline underline-offset-2 text-checkout-300'>hello@oyinye.com</Link> and we&apos;ll be in touch.
                            </p>
                        </div>
                        <form className="space-y-5 lg:w-[130%] w-full text-sm" onSubmit={handleFormSubmit}>
                            <header className="lg:text-4xl text-3xl font-light">Contact Form</header>
                            <div className="w-full flex md:flex-row flex-col gap-y-4">
                                <div className="flex flex-col gap-y-2 md:w-[49%] w-full">
                                    <div className="w-full flex flex-col gap-y-2">
                                        <label htmlFor="fName" className="tracking-widest">FIRST NAME</label>
                                        <input 
                                    ...
                                    <p id='fname-error' className="text-red-600 text-xs font-sans hidden -mt-1">A first name is required</p>
                                </div>
                                <div className="w-[2%] hidden md:block"></div>
                                <div className="md:w-[49%] w-full flex flex-col gap-y-2">
                                    <div className="w-full flex flex-col gap-y-2">
                                        <label htmlFor="lName" className="tracking-widest">LAST NAME</label>
                                        <input 
                                    ...
                                    <p id='lname-error' className="text-red-600 text-xs font-sans hidden -mt-1">A last name is required</p>
                                </div>
                            </div>
                            <div className="w-full flex flex-col gap-y-2">
                                <div className="w-full flex flex-col gap-y-2 ">
                                    <label htmlFor="email" className="tracking-widest">EMAIL</label>
                                    <input 
                            ...
                            <div className="w-full flex flex-col gap-y-2">
                                <div className="w-full flex flex-col gap-y-2 ">
                                    <label htmlFor="subject" className="tracking-widest">SUBJECT</label>
                                    <input 
                                        ...
                                        onBlur={(e) => {
                                            if(e.target.value.length === 0){
                                                ...
                                                document.querySelector('#subject-error')?.classList.add('hidden');
                                            }
                                        }} 
                                        id='subject' 
                                        className="focus:outline-none text-[1rem] focus:rounded-md placeholder:text-[1rem] placeholder:font-light focus:border-2 focus:border-gray-600 font-light px-3 py-2 border border-gray-300"
                                ...
                                <p id='subject-error' className="text-red-600 text-xs font-sans hidden -mt-1">Provide a subject for your message</p>
                            </div>
                            <div className="w-full flex flex-col gap-y-2">
                                <div className="w-full flex flex-col gap-y-2">
                                    <label htmlFor="message" className="tracking-widest">MESSAGE</label>
                                    <textarea 
                                ...
                                <p id='message-error' className="text-red-600 text-xs font-sans hidden -mt-1">Why are you contacting us?</p>
                            </div>
                            <div className="pt-7 w-full">
                                <button type='submit' className="text-white bg-black py-4 hover:ring-black hover:ring-1 w-full text-[1rem]">{loader ? 'Processing' : 'Submit Form'}</button>
                            </div>
                        </form>
                    </article>
